...
See https://github.com/dotenx/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/dotenx/goth/examples/main.go to see this in action.
*/
